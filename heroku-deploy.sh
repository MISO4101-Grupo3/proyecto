...
APPLICATION_FOLDER=${APPLICATION_FOLDER:?'Set the APPLICATION_FOLDER environment variable.'}
AFTER_DEPLOYMENT_WAIT_TIME=5

echo "STARTING DEPLOYMENT"
echo $HEROKU_APP_NAME

#function error_message() { echo -e "DEPLOYMENT FAILED on line $1 of the deployment script" }
